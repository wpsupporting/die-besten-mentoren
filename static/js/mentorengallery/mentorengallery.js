document.addEventListener("DOMContentLoaded", function () {
    ...
    // Optionen aus HTML-Attributen auslesen
    const loop = slider.getAttribute("data-loop") === "true";
    const autoplay = slider.getAttribute("data-autoplay") === "true";
    const slideSpeed = parseInt(slider.getAttribute("data-slide-speed")) || 7000;
    ...
    const smartphoneLandscapeItems = parseInt(slider.getAttribute("data-smartphone-landscape-items")) || 2;
    const tabletPortraitItems = parseInt(slider.getAttribute("data-tablet-portrait-items")) || 1;
    const tabletLandscapeItems = parseInt(slider.getAttribute("data-tablet-landscape-items")) || 2;
    const desktopItems = parseInt(slider.getAttribute("data-desktop-items")) || 3;
  
    // Initialisierung des Sliders mit Slick
    $(slider).slick({
        slidesToShow: desktopItems, // Standardanzahl
        slidesToScroll: 1,
        infinite: loop,
        autoplay: autoplay,
    ...
    console.log("Mentorengalerie-Slider erfolgreich initialisiert.");
});
