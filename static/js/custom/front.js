...
$(document).ready(function(){
  $('.owl-carousel').owlCarousel({
      items: 4, // Standardanzahl der sichtbaren Elemente
      margin: 10, // Abstand zwischen den Elementen
      loop: true, // Endlos-Schleife
      autoplay: true, // Automatisches Scrollen
      autoplayTimeout: 3000, // Geschwindigkeit des Autoscrollens (in Millisekunden)
      responsive: { // Anpassung an verschiedene Bildschirmgrößen
          0: {
              items: 1 // 1 Element für kleine Bildschirme
          },
          600: {
              items: 2 // 2 Elemente für mittlere Bildschirme
          },
          1000: {
              items: 4 // 4 Elemente für große Bildschirme
          }
      }
  });
});
